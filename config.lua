...
config.DefaultWidgets = {
    ...
    text1 = { type = "StaticText", point="CENTER", width = 40, height = 16, x=0, y=0, font = config.defaultFont, textsize = 12, effect = "SHADOW", bg = false, bgAlpha = 0.5 },
    text2 = { type = "StaticText", point="CENTER", width = 10, height = 10, x=0, y=-11, font = config.defaultFont, textsize = 10, effect = "NONE" },
    text3 = { type = "Text", point="TOPLEFT", width = 10, height = 10, x=2, y=0, font = config.defaultFont, textsize = 9, effect = "NONE" },
