...
config.DefaultWidgets = {
    ...
    text1 = { type = "StaticText", point="CENTER", x=0, y=0, textsize = 12 },
    text2 = { type = "StaticText", point="CENTER", x=0, y=-10, textsize = 10 },
    text3 = { type = "Text", point="TOPLEFT", x=2, y=0, textsize = 9 },
}
